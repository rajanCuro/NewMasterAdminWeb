...
function AddUpdatePincode() {
    const { user } = useAuth();
    console.log('user', user); // Make sure user contains city, zone, state info
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axiosInstance.post('/city-admin/addNewPinCode', payload);
            Swal.fire({
                icons:'success',
                title: 'Success',
